                ...
                <td className="p-3">
                  <div className="space-y-3">
                    <form action={setAdminStatusAction}>
                      ...
                      />
                      <button
                        disabled={admin.id === current.id && admin.isActive}
                    ...
                    >
                      ...
                      <PasswordInput
                        ...
                        className="w-48 rounded border-line text-sm"
                      />
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm text-muted">
            Changing your password revokes existing sessions. Sign in again with
            the new password.
          </p>
          <button className="w-fit rounded bg-accent px-3 py-2 text-sm font-medium text-white">
            Change password
