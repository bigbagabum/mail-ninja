...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-panel px-4">
      <form
        action={action}
        className="w-full max-w-sm rounded border border-line bg-white p-6 shadow-sm"
      >
        ...
        <button
          disabled={pending}
          className="mt-6 w-full rounded bg-accent px-3 py-2 font-medium text-white disabled:opacity-60"
        >
          Sign in
        </button>
      </form>
