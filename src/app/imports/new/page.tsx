...
import {
  buildRecipientImportStructureText,
  recipientImportColumns,
  recipientImportCsvHeader,
} from "@/lib/imports/recipient-template";
...
export default async function NewImportPage() {
  ...
  return (
    <>
      <PageHeader title="Upload Audience CSV" />
      <AudienceNav />
      <div className="grid gap-6 lg:grid-cols-[minmax(0,560px)_1fr]">
        ...
        >
          ...
          <p className="mt-3 text-sm text-muted">
            UTF-8 CSV with comma or semicolon delimiter. Email is the only
            required mapped field.
          </p>
          <button className="mt-5 rounded bg-accent px-3 py-2 text-sm font-medium text-white">
            Upload
          </button>
        </form>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-muted">
                Use this structure when exporting recipients from another
                database.
              </p>
            </div>
